...
export default function EventsProductionsPage() {
  ...
  return (
    <main className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#c8a030]/3 rounded-full blur-3xl animate-float" style={{ animationDelay: '3s' }}></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#c8a030]/2 rounded-full blur-3xl animate-pulse"></div>
      </div>
      ...
      <div 
        ...
        style={{
          backgroundImage: 'repeating-linear-gradient(90deg, rgba(236, 229, 248, 0.03), rgba(236, 229, 248, 0.03) 1px, transparent 1px, transparent 60px)'
        }}
      />
      ...
      <div className={`relative z-10 text-center px-6 md:px-12 transition-all duration-1000 ${
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative w-24 h-24 md:w-32 md:h-32">
            <div className="absolute inset-0 border-2 border-[#c8a030]/30 rounded-full animate-pulse"></div>
            <div className="absolute inset-4 border-2 border-[#c8a030]/20 rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-3 h-3 bg-[#c8a030] rounded-full animate-pulse"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          <div className="h-[1px] w-16 bg-gradient-to-r from-transparent to-[#c8a030]/50"></div>
          <div className="w-2 h-2 bg-[#c8a030] rounded-full animate-pulse"></div>
          <div className="h-[1px] w-16 bg-gradient-to-l from-transparent to-[#c8a030]/50"></div>
        </div>
