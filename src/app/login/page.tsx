...
import { Lock, Mail, ArrowRight, Eye, EyeOff, CheckCircle2, MailCheck, RefreshCw, Loader2 } from "lucide-react";
      ...
      <Suspense
        fallback={
          <div className="relative z-10 flex flex-col items-center gap-4">
            ...
            <p className="text-white/40 text-sm font-light">Loading…</p>
          </div>
        }
      >
        <LoginContent />
