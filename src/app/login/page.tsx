...
export default function LoginPage() {
  ...
  // On mount: restore saved email + show "email verified" toast if redirected from /auth/verified
  useEffect(() => {
    ...
    // Read query params via window.location (avoids useSearchParams / Suspense requirement)
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-[#030303] overflow-hidden font-body text-white">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-[0%] left-[-10%] w-[600px] h-[600px] bg-[#c8a030]/10 rounded-full blur-[150px] animate-pulse mix-blend-screen" style={{ animationDuration: "10s" }} />
        <div className="absolute bottom-[-20%] right-[-10%] w-[700px] h-[700px] bg-[#c8a030]/5 rounded-full blur-[150px] animate-pulse mix-blend-screen" style={{ animationDuration: "15s" }} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-[420px] px-6 py-12 mx-auto">
        ...
        {!verificationSent && (
          <>
            ...
            <div
              className="bg-[#0d0803]/90 backdrop-blur-2xl border border-white/10 rounded-[24px] p-8 shadow-2xl animate-scale-in relative overflow-hidden"
              style={{ animationDelay: "0.2s" }}
            >
              {/* Progress loader bar */}
              {isLoading && (
                <div className="absolute top-0 left-0 w-full h-[2px] bg-white/10">
                  <div className="h-full bg-[#c8a030] animate-expand-line origin-left" />
                </div>
              )}
              ...
              <form onSubmit={handleCredentialsSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <label className="text-[11px] font-franklin uppercase tracking-[0.15em] text-white/50 pl-1">
                    Email Address
                  </label>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between pl-1">
                    <label className="text-[11px] font-franklin uppercase tracking-[0.15em] text-white/50">
                      Password
                    </label>
                    {isLogin && (
                ...
                {isLogin && (
                  <div className="flex items-center gap-2 pt-1">
                    ...
                    <span
                      className="text-[12px] text-white/60 cursor-pointer select-none"
                      onClick={() => setRememberMe(!rememberMe)}
                    >
                      Remember my email
                    </span>
              ...
              <div className="relative flex items-center py-6">
                ...
                <span className="flex-shrink-0 mx-4 text-[10px] uppercase tracking-widest text-white/30 font-franklin">
                  Or continue with
                </span>
                <div className="flex-grow border-t border-white/5" />
              </div>
