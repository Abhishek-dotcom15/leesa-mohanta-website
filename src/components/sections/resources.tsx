...
const ResourcesSection = () => {
  return (
    <section id="resources" className="relative w-full bg-black text-[#f0e6d3] py-[120px] loom-texture overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <div className="space-y-8">
            <div>
              ...
              <p className="font-body text-[16px] lg:text-[18px] text-[#8a7050] font-light leading-relaxed">
