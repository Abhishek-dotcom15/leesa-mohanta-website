...
const EventsProductions = () => {
  ...
  return (
    <section ref={sectionRef} id="events-productions" className="relative w-full bg-black text-[#f0e6d3] py-[120px] overflow-hidden loom-texture">
      {/* Animated Background Elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#c8a030]/5 rounded-full blur-3xl animate-float"></div>
        <div className="absolute bottom-1/4 left-1/4 w-[500px] h-[500px] bg-[#c8a030]/3 rounded-full blur-3xl animate-float" style={{ animationDelay: '3.5s' }}></div>
      </div>
